...
public class CAANutation {
    ...
    public static double MeanObliquityOfEcliptic(double JD) {
        ...
        return CAACoordinateTransformation.DMSToDegrees(23, 26, 21.448, true) - CAACoordinateTransformation.DMSToDegrees(0, 0, 4680.93, true) * U - CAACoordinateTransformation.DMSToDegrees(0, 0, 1.55, true) * Usquared + CAACoordinateTransformation.DMSToDegrees(0, 0, 1999.25, true) * Ucubed - CAACoordinateTransformation.DMSToDegrees(0, 0, 51.38, true) * U4 - CAACoordinateTransformation.DMSToDegrees(0, 0, 249.67, true) * U5 - CAACoordinateTransformation.DMSToDegrees(0, 0, 39.05, true) * U6 + CAACoordinateTransformation.DMSToDegrees(0, 0, 7.12, true) * U7 + CAACoordinateTransformation.DMSToDegrees(0, 0, 27.87, true) * U8 + CAACoordinateTransformation.DMSToDegrees(0, 0, 5.79, true) * U9 + CAACoordinateTransformation.DMSToDegrees(0, 0, 2.45, true) * U10;
    }

    public static double TrueObliquityOfEcliptic(double JD) {
        return MeanObliquityOfEcliptic(JD) + CAACoordinateTransformation.DMSToDegrees(0, 0, NutationInObliquity(JD), true);
    }
