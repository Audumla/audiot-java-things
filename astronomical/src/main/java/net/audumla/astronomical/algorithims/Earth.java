...
public class Earth implements AstronomicalObject {
    ...
    public static VSOP87Coefficient[] g_L3EarthCoefficients = {
    ...
    public static VSOP87Coefficient[] g_L4EarthCoefficients = {
    ...
    public static VSOP87Coefficient[] g_B0EarthCoefficients = {
    ...
    public static VSOP87Coefficient[] g_B1EarthCoefficients = {
    ...
    public static VSOP87Coefficient[] g_R2EarthCoefficients = {
    ...
    public static VSOP87Coefficient[] g_R3EarthCoefficients = {
    ...
    public static VSOP87Coefficient[] g_L3EarthCoefficientsJ2000 = {
    ...
    public static VSOP87Coefficient[] g_L4EarthCoefficientsJ2000 = {
            new VSOP87Coefficient(8, 4.14, 6283.08),
            new VSOP87Coefficient(1, 3.28, 12566.15)
    };
    public static VSOP87Coefficient[] g_B1EarthCoefficientsJ2000 = {
    ...
    public static VSOP87Coefficient[] g_B2EarthCoefficientsJ2000 = {
    ...
    public static VSOP87Coefficient[] g_B3EarthCoefficientsJ2000 = {
            new VSOP87Coefficient(276, 0.595, 6283.076),
            new VSOP87Coefficient(17, 3.14, 0),
            new VSOP87Coefficient(4, 0.12, 12566.15)
    };
    public static VSOP87Coefficient[] g_B4EarthCoefficientsJ2000 = {
    ...
    public double eclipticLatitude(double JD) {
        ...
        //convert results back to degrees
        value = CoordinateTransformation.radiansToDegrees(value);
        return value;
    }
    ...
    public double eclipticLatitudeJ2000(double JD) {
        double rho = (JD - 2451545) / 365250;
        double rhosquared = rho * rho;
        double rhocubed = rhosquared * rho;
        double rho4 = rhocubed * rho;
    ...
    public double sunMeanAnomaly(double JD) {
        double T = (JD - 2451545) / 36525;
        double Tsquared = T * T;
        double Tcubed = Tsquared * T;
        return CoordinateTransformation.MapTo0To360Range(357.5291092 + 35999.0502909 * T - 0.0001536 * Tsquared + Tcubed / 24490000);
    }

    public double eccentricity(double JD) {
        double T = (JD - 2451545) / 36525;
        double Tsquared = T * T;
