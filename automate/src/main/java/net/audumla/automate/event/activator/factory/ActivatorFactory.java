...
public interface ActivatorFactory<TActivator extends Activator> {
     ...
     *
     * @throws Exception thrown if shutdown fails
     */
     ...
     * @throws Exception thrown if the the states failed to set
     */
     ...
     * @return true if the assignment of the activators completed successfully
     * @throws Exception thrown if the the state failed to set
     */
