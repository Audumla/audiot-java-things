...
public class ThreadPoolEventScheduler extends AbstractEventScheduler{
    private static final Logger logger = LoggerFactory.getLogger(ThreadPoolEventScheduler.class);
