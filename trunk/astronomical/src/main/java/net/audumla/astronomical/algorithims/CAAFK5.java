...
public class CAAFK5
{
    public static double CorrectionInLongitude(double Longitude, double Latitude, double JD)
    {
        ...
        return CAACoordinateTransformation.DMSToDegrees(0, 0, value,true);
    }
    ...
    public static CAA3DCoordinate ConvertVSOPToFK5AnyEquinox(CAA3DCoordinate value, double JDEquinox)
    {
        ...
        sigma = CAACoordinateTransformation.DegreesToRadians(CAACoordinateTransformation.DMSToDegrees(0, 0, sigma,true));

        double zeta = 2306.2181 * t + 1.09468 * tsquared + 0.018203 * tcubed;
        zeta = CAACoordinateTransformation.DegreesToRadians(CAACoordinateTransformation.DMSToDegrees(0, 0, zeta,true));

        double phi = 2004.3109 * t - 0.42665 * tsquared - 0.041833 * tcubed;
        phi = CAACoordinateTransformation.DegreesToRadians(CAACoordinateTransformation.DMSToDegrees(0, 0, phi,true));
