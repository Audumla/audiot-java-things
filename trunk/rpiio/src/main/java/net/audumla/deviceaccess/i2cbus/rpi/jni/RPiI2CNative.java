...
public class RPiI2CNative {
     ...
     */
    public static native int write(int fd, int address, byte localAddress, byte value, byte mask);
     ...
     */
    public static native byte read(int fd, int address, byte localAddress);
     ...
     * @return return a negative value if an error was encountered otherwise the number of bytes read
     */
    public static native int write(int fd, int address, byte value, byte mask);
     ...
     * @return returns the value read from the device
     */
    public static native byte read(int fd, int address);
     ...
     * @return return a negative value if an error was encountered otherwise the number of bytes read
     */
    public static native int write(int fd, int address, int offset, int width, int writeCount, byte[] writeBuffer, byte[] mask);
     ...
     * @return return a negative value if an error was encountered otherwise the number of bytes read
     */
    public static native int write(int fd, int address, byte localAddress, int offset, int width, int writeCount, byte[] writeBuffer, byte[] mask);
